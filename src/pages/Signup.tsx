...
import { handleGoogleSignUp } from "../config/sbFunctions";
...
export default function LoginPage() {
  ...
  const handleGoogleLogin = async () => {
    setLoading(true);
    let { data, error }: any = await handleGoogleSignUp();
    if (data) {
      message.success('Google signup success')
    }
    else {
        ...
        <div className="flex flex-col lg:flex-row bg-white/95 backdrop-blur-sm rounded-xl border border-gray-200 shadow-lg overflow-hidden">
          ...
          <div className="lg:w-1/2 p-8 bg-gradient-to-br from-blue-50 to-cyan-50 flex flex-col justify-center">
            <div className="mb-6">
              <div className="relative inline-block mb-4">
                <h1 className="text-5xl lg:text-6xl font-extrabold bg-gradient-to-r from-cyan-600 via-blue-600 to-cyan-600 bg-clip-text text-transparent"
              ...
              <p className="text-gray-500 text-xs">
                Transform your workflow with Cliento
              </p>
            </div>
            ...
            <div className="space-y-3 mb-6">
              <div className="flex items-center gap-2">
                ...
                <p className="text-sm font-medium text-gray-800">AI Powered Workflow</p>
              </div>
              ...
              <div className="flex items-center gap-2">
                ...
                <p className="text-sm font-medium text-gray-800">Real-time Collaboration</p>
              </div>
          ...
          <div className="lg:w-1/2 p-8 flex flex-col justify-center">
            <div className="text-center mb-6">
              ...
              <p className="text-gray-500 text-sm">Join thousands of teams using Cliento</p>
            </div>
            ...
            <div className="flex justify-between text-xs mb-4">
              <Link
                to={""} className="text-gray-500 hover:text-blue-600 hover:underline transition-colors px-2 py-1 rounded hover:bg-blue-50">
                Forgot password?
              </Link>
              <Link
                to={'/auth/signup'} className="text-blue-600 hover:text-blue-700 hover:underline font-medium transition-colors px-2 py-1 rounded hover:bg-blue-50"
              >
                Create Account →
              </Link>
            </div>
            ...
            <div className="mb-4">
              <div className="flex items-center justify-center gap-3">
                ...
                <div>
                  <p className="text-xs font-medium text-gray-700">Join 5,000+ teams</p>
                </div>
              </div>
            </div>
            ...
            <div className="pt-4 border-t border-gray-200">
              <p className="text-xs text-gray-400 text-center">
                ...
                <Link to={""} className="text-blue-500 hover:text-blue-600 hover:underline">Terms</Link>
                {' '}&{' '}
                <Link to={""} className="text-blue-500 hover:text-blue-600 hover:underline">Privacy</Link>
              </p>
            </div>
          </div>
        </div>
